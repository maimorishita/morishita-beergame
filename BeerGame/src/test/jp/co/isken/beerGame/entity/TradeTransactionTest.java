...
//		assertEquals("１週目の在庫に誤りがあります", 29, map.get(1L).intValue());
//		assertEquals("２週目の在庫に誤りがあります", 29, map.get(2L).intValue());
//		assertEquals("３週目の在庫に誤りがあります", 24, map.get(3L).intValue());
//		assertEquals("４週目の在庫に誤りがあります", 11, map.get(4L).intValue());
//		assertEquals("５週目の在庫に誤りがあります", -4, map.get(5L).intValue());
//		assertEquals("６週目の在庫に誤りがあります", 9, map.get(6L).intValue());
	}
